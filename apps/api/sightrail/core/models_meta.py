...
FORMAT_NOTES: dict[str, dict[str, str]] = {
    ...
    "tflite": {"label": "LiteRT / TFLite", "note": "Mobile and embedded CPUs."},
    ...
    "litert": {"label": "LiteRT", "note": "Google's modern TFLite replacement."},
...
TRACKERS: list[dict[str, Any]] = [
    {
        "id": "tracktrack.yaml",
        "label": "TrackTrack",
        "description": "Ultralytics' default tracker: motion + appearance, no extra deps.",
        "requires": [],
        "recommended": True,
    },
    {
        "id": "bytetrack.yaml",
        "label": "ByteTrack",
        "description": "High-performance association using low-confidence boxes.",
        "requires": [],
    },
    {
        "id": "botsort.yaml",
